...
$spreadsheet->getProperties()->setCreator("Anonimo")->
    setTitle("Reporte en Excel");
//Aquí establecemos la posición en la que se va a trabajar. 0 para
//indicar que empezaremos de la pagina 0
$spreadsheet->setActiveSheetIndex(0);
//Aquí declaramos la hoja en la que se va a trabajar
$hojaActiva = $spreadsheet->getActiveSheet();
///Estas Funciones son para cambiar la fuente y el tamaño
//respectivamente
...
//header('Content-Disposition:attachment;filename="Reporte enexcel.xlsx"');
