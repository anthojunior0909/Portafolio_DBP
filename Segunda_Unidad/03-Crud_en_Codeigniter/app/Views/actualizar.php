        ...
        <div class="row">
            <div class="col-sm-12">
                <form method="POST" action="<?php echo base_url() . '/actualizar' ?>">
                    ...
                    <input type="text" name="paterno" id="paterno" class="formcontrol" value="<?php echo $paterno ?>">
                    <label for="materno">Apellido materno</label>
                    <input type="text" name="materno" id="materno" class="formcontrol" value="<?php echo $materno ?>">
                    <br>
